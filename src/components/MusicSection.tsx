...
export default function MusicSection() {
  ...
  const staticTracks: Track[] = [
    { filename: 'snail on my hand.mp3', path: '/audio/snail on my hand.mp3', name: 'snail on my hand' },
    { filename: 'Intranquillo.mp3', path: '/audio/Intranquillo.mp3', name: 'Intranquillo' },
    { filename: 'then you dont want do anything.mp3', path: '/audio/then you dont want do anything.mp3', name: 'then you dont want do anything' },
    { filename: 'Жаворонок.wav', path: '/audio/Жаворонок.wav', name: 'Жаворонок' },
    { filename: 'malachit forest.wav', path: '/audio/malachit forest.wav', name: 'malachit forest' },
  ];
    ...
    <section className="flex items-center justify-center bg-dark-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {staticTracks.map((track: Track, index: number) => (
            <div
              key={index}
